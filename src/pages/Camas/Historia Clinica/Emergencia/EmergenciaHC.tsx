          ...
          <Box sx={{ display: "flex", flexWrap: "wrap", gap: 2 }}>
            <Box sx={{ flex: "1 1 300px" }}>
              <TextField
                ...
                defaultValue="RPC (RED PUBLICA COMPLEMENTARIA)"
                fullWidth
                variant="outlined"
                size="small"
            ...
            <Box sx={{ flex: "1 1 300px" }}>
              <TextField
                ...
                variant="outlined"
                size="small"
                placeholder="Número de cédula/pasaporte/carnet"
                InputProps={{ readOnly: true }}
              />
            </Box>
            <Box sx={{ flex: "1 1 300px" }}>
              <TextField
                ...
                variant="outlined"
                size="small"
                placeholder="Número de archivo de estadística"
                InputProps={{ readOnly: true }}
              />
            </Box>
          </Box>
      ...
      <Card sx={{ mb: 3, boxShadow: 3 }}>
        <CardContent>
          ...
          <Box sx={{ display: "flex", flexWrap: "wrap", gap: 2, mb: 3 }}>
            ...
            <Box sx={{ flex: "1 1 250px" }}>
              <TextField
                label="Nombre y apellido del admisionista"
                fullWidth
                variant="outlined"
                size="small"
                InputProps={{ readOnly: true }}
          ...
          <Box sx={{ mb: 3 }}>
            <FormControl component="fieldset">
              ...
              <RadioGroup row name="documento-type" sx={{ mt: 1 }}>
                <FormControlLabel
                  value="CC/CI"
                  control={<Radio />}
                  label="CC/CI"
          ...
          <Box sx={{ mb: 3 }}>
            <FormControl component="fieldset">
              ...
              <RadioGroup row name="estado-civil" sx={{ mt: 1 }}>
                <FormControlLabel
                  value="Sol"
                  control={<Radio />}
                  label="Sol = Soltera"
                ...
                <FormControlLabel
                  value="Un"
                  control={<Radio />}
                  label="Un = Unión libre"
                />
                <FormControlLabel
                  value="U-H"
                  control={<Radio />}
                  label="U-H = Unión de hecho"
                />
                <FormControlLabel
                  value="N/A"
                  control={<Radio />}
                  label="N/A = Ninguna de las anteriores"
                />
              </RadioGroup>
            </FormControl>
          </Box>
          ...
          <Box sx={{ mb: 3 }}>
            <FormControl component="fieldset">
              ...
              <RadioGroup row name="sexo" sx={{ mt: 1 }}>
                <FormControlLabel
                  value="M"
                  control={<Radio />}
                  label="Mujer (M)"
          ...
          <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
            ...
            <Box sx={{ display: "flex", flexWrap: "wrap", gap: 2 }}>
              ...
              <Box sx={{ flex: "1 1 200px" }}>
                <TextField
                  label="Institución o persona que entrega al paciente"
                  fullWidth
                  variant="outlined"
                  size="small"
                  InputProps={{ readOnly: true }}
